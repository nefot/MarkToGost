...
# 10. Функциональный уровень реализации, расчёт и структуры магистральной, вертикальной и горизонтальной подсистем СКС
...
здания не должна превышать 20 м.
...
Коммутационные шнуры непосредственно подключают компьютер к сети. Длина коммутационных шнуров не должна превышать 5
метров.
...
комнаты. Температура комнаты должна составлять от 18 до 24 °С, а относительная влажность — от 30 до 50%. Температуру и
