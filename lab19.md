...
![Настройка IP-адресации](img_10.png)
...
![Проверка ping внутри VLAN](img_12.png)
...
![Ручная настройка trunk](img_15.png)
...
![Проверка связи через trunk](img_16.png)
